...
class TelegramBotService:
    def __init__(
        ...
        self.default_chat_id = str(default_chat_id or os.environ.get("TELEGRAM_CHAT_ID", "7690577065")).strip()
    ...
    def format_daily_picks_html(self, summary: MarketSummaryResponse) -> str:
        ...
        lines = [
            "<b>📊 BRIGHTS — REKOMENDASI SAHAM PILIHAN ESOK HARI</b>",
        ...
        lines.append("🤖 <b>Generated by BRIGHTS Intelligence • @TradeXQBot</b>")
    ...
    def send_test_message(self, chat_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        text = (
            "<b>🔔 BRIGHTS — Test Koneksi Telegram Bot Berhasil!</b>\n\n"
